...
class staffdanbranch extends Seeder
{
    /**
    ...
    {
        $SB = [
            ['staffNo' => 'S121', 'sName' => 'John White', 'position' => 'Manager', 'salary' => "30000", 'branchNo' => 'B005', 'bAddress' => '22 Deer Rd, London'],
        ...
        DB::table('staffdanbranch')->insert($SB);
    }
}
